...
func (a questionHasManyAttachedImageList) Where(conds ...field.Expr) *questionHasManyAttachedImageList {
	if len(conds) == 0 {
		return &a
	}
...
func (a questionHasManyAttachedImageList) WithContext(ctx context.Context) *questionHasManyAttachedImageList {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a questionHasManyAttachedImageList) Session(session *gorm.Session) *questionHasManyAttachedImageList {
...
func (a questionHasManyAttachedImageList) Unscoped() *questionHasManyAttachedImageList {
	a.db = a.db.Unscoped()
	return &a
}
...
func (a questionHasManyAttachedImageListTx) Clear() error {
	return a.tx.Clear()
}

func (a questionHasManyAttachedImageListTx) Count() int64 {
	return a.tx.Count()
}

func (a questionHasManyAttachedImageListTx) Unscoped() *questionHasManyAttachedImageListTx {
	a.tx = a.tx.Unscoped()
	return &a
}
